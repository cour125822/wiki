...
| [upperopen in new window](https://numpy.org/devdocs/reference/generated/numpy.char.upper.html#numpy.char.upper)(a) | 返回一个数组，其中元素转换为大写。                           |
...
## [#](https://www.numpy.org.cn/reference/routines/char.html#便利构造函数)便利构造函数
